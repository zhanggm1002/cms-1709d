...
Source Database       : cms_1709d

Target Server Type    : MYSQL
Target Server Version : 50525
File Encoding         : 65001

Date: 2019-12-12 10:04:52
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for bak_cms_collect
-- ----------------------------
DROP TABLE IF EXISTS `bak_cms_collect`;
CREATE TABLE `bak_cms_collect` (
...
-- ----------------------------
-- Records of bak_cms_collect
-- ----------------------------
INSERT INTO `bak_cms_collect` VALUES ('23', '卖电动车赚钱有多难？', 'http://127.0.0.1/article?id=2', '2019-11-23 11:06:09', '168');
INSERT INTO `bak_cms_collect` VALUES ('24', '雷军股市往事：A股火爆身家一天暴涨150亿，港股破发说大势不好', 'http://127.0.0.1/article?id=1', '2019-11-23 11:06:34', '168');
INSERT INTO `bak_cms_collect` VALUES ('25', '雷军股市往事：A股火爆身家一天暴涨150亿，港股破发说大势不好', 'http://127.0.0.1/article?id=1', '2019-11-23 11:07:40', '169');

-- ----------------------------
-- Table structure for bak_cms_links
-- ----------------------------
DROP TABLE IF EXISTS `bak_cms_links`;
CREATE TABLE `bak_cms_links` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of bak_cms_links
-- ----------------------------
INSERT INTO `bak_cms_links` VALUES ('6', '京东', 'https://www.jd.com', '2019-08-22 10:28:33');
INSERT INTO `bak_cms_links` VALUES ('7', '百度', 'https://www.baidu.com', null);
INSERT INTO `bak_cms_links` VALUES ('8', '淘宝', 'https://www.taobao.com', '2019-08-22 11:15:13');
INSERT INTO `bak_cms_links` VALUES ('11', '头条', 'https://www.toutiao.com/', '2019-11-23 09:04:37');
...
CREATE TABLE `cms_article` (
  ...
  `hot` int(11) DEFAULT NULL COMMENT '是否热门',
  ...
  `commentCnt` varchar(255) DEFAULT NULL COMMENT '评论数量',
  PRIMARY KEY (`id`),
...
CREATE TABLE `cms_article_vote` (
  ...
  `user_id` int(11) DEFAULT NULL COMMENT '用户Id',
  `option` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '选项',
  PRIMARY KEY (`id`)
...
CREATE TABLE `cms_channel` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='频道表';
...
CREATE TABLE `cms_comment` (
  ...
  `content` varchar(512) CHARACTER SET utf8 DEFAULT NULL COMMENT '评论内容',
  `created` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '评论时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `cms_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_domain` varchar(50) DEFAULT NULL COMMENT '网站域名',
  `site_name` varchar(50) DEFAULT NULL COMMENT '网站名称',
  `article_list_size` int(11) DEFAULT NULL COMMENT '文章列表数据条数',
  `slide_size` int(11) DEFAULT NULL COMMENT '轮播图最大条数',
  `admin_username` varchar(16) DEFAULT NULL COMMENT '管理员帐号',
...
CREATE TABLE `cms_slide` (
  ...
  `picture` varchar(50) DEFAULT NULL COMMENT '图片地址',
  `url` varchar(50) DEFAULT NULL COMMENT '链接url',
  PRIMARY KEY (`id`)
...
CREATE TABLE `cms_tag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tagname` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '标签名称',
  PRIMARY KEY (`id`)
...
-- Records of cms_user
-- ----------------------------
INSERT INTO `cms_user` VALUES ('137', 'lisi', '123456', null, null, null, null, null, null, null, null, null);
INSERT INTO `cms_user` VALUES ('138', '王三', '8d1c9457e01d9803f1caaeab87c8c07a', 'wangsan', '2019-10-10', '0', '0', null, '0', null, '2019-10-03 09:58:41', '2019-10-23 09:58:44');
INSERT INTO `cms_user` VALUES ('152', 'zl', '8d1c9457e01d9803f1caaeab87c8c07a', '赵六', null, '1', '0', null, '0', null, '2019-10-22 11:12:02', '2019-10-22 11:12:02');
INSERT INTO `cms_user` VALUES ('153', 'admin', '8d1c9457e01d9803f1caaeab87c8c07a', '管理员', null, '1', '0', null, '1', null, '2019-10-22 11:12:02', '2019-10-22 11:12:02');
INSERT INTO `cms_user` VALUES ('155', '今天头条', '8d1c9457e01d9803f1caaeab87c8c07a', '今天头条', null, '1', '0', null, '0', 'https://www.jd.com/', '2019-10-22 11:12:02', '2019-10-22 11:12:02');
INSERT INTO `cms_user` VALUES ('156', '田七', '8d1c9457e01d9803f1caaeab87c8c07a', '田七', null, '1', '0', null, '0', null, '2019-11-07 16:06:45', '2019-11-07 16:06:45');
INSERT INTO `cms_user` VALUES ('157', '李四', '8d1c9457e01d9803f1caaeab87c8c07a', '李四', null, '1', '0', null, '0', null, '2019-11-07 16:08:57', '2019-11-07 16:08:57');
INSERT INTO `cms_user` VALUES ('159', 'bawei', '8d1c9457e01d9803f1caaeab87c8c07a', 'bawei', null, '1', '1', null, '0', null, '2019-11-08 13:12:23', '2019-11-08 13:12:23');
INSERT INTO `cms_user` VALUES ('160', '1707E', '8d1c9457e01d9803f1caaeab87c8c07a', '1707E', null, '1', '0', null, '0', null, '2019-11-12 14:17:22', '2019-11-12 14:17:22');
INSERT INTO `cms_user` VALUES ('161', 'yangchunpo', '111111', null, null, '1', '0', null, '0', null, null, null);
INSERT INTO `cms_user` VALUES ('162', 'yangchunpo222', '111111', null, null, '1', '0', null, '0', null, null, null);
INSERT INTO `cms_user` VALUES ('168', '1707', '8d1c9457e01d9803f1caaeab87c8c07a', null, null, '1', '0', null, '0', null, null, null);
INSERT INTO `cms_user` VALUES ('169', '17077', '8d1c9457e01d9803f1caaeab87c8c07a', null, null, '1', '0', null, '0', null, '2019-11-20 10:50:06', null);

-- ----------------------------
-- Table structure for cms_vote_content
-- ----------------------------
DROP TABLE IF EXISTS `cms_vote_content`;
CREATE TABLE `cms_vote_content` (
  `id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='投票内容表';

-- ----------------------------
-- Records of cms_vote_content
-- ----------------------------
